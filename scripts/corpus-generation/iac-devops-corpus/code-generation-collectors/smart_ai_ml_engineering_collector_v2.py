...
logger = logging.getLogger("smart_ai_ml_engineering")

class SmartAIMLEngineeringCollector(SmartCollectorBase):
    """Smart collector for code generation examples using content-first approach"""
    
    def __init__(self, github_token: Optional[str] = None):
        super().__init__("ai_ml_engineering", github_token)
...
def main():
    ...
    collector = SmartAIMLEngineeringCollector()
    
    # Collect examples
    examples = collector.collect_domain_examples(target_count=500)
    
    # Save to file
    output_path = "/home/shingai/sort/deployments/data/corpus/smart_ai_ml_engineering_corpus.jsonl"
